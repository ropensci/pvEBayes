...
#> ✔ Fitting general-gamma model... [203ms]
#> 
...
#> 
#> Running time of the general-gamma model fitting: 0.2109 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (1000 signal strength posterior draws per AE-drug pair):0.0435 seconds.
#> 
...
#> 
#> Running time of the K-gamma model fitting: 0.0313 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (1000 signal strength posterior draws per AE-drug pair):0.0408 seconds.
#> 
#> Extract estimated prior parameters, discovered signals
#> and signal strength posterior draws using `summary()`.
...
#> ✔ Fitting efron model... [227ms]
#> 
#> ℹ Generating 1000 posterior draws...
#> ✔ Generating 1000 posterior draws... [42ms]
#> 
#> Object of class 'pvEBayes'
#> 
#> efron model is fitted with hyperparameters (p = 40, c0 = 0.05).
#> 
#> Running time of the efron model fitting: 0.2394 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (1000 signal strength posterior draws per AE-drug pair):0.0539 seconds.
#> 
#> Extract estimated prior parameters, discovered signals
#> and signal strength posterior draws using `summary()`.
...
#> 
#> Running time of the GPS model fitting: 0.0383 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (1000 signal strength posterior draws per AE-drug pair):0.0396 seconds.
#> 
#> Extract estimated prior parameters, discovered signals
#> and signal strength posterior draws using `summary()`.
