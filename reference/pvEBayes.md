...
#> 
#> Running time of the general-gamma model fitting: 0.231 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (1000 signal strength posterior draws per AE-drug pair):0.0445 seconds.
#> 
...
#> 
#> Running time of the K-gamma model fitting: 0.0331 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
...
#> 
#> Running time of the efron model fitting: 0.3894 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (1000 signal strength posterior draws per AE-drug pair):0.0505 seconds.
#> 
#> Extract estimated prior parameters, discovered signals
#> and signal strength posterior draws using `summary()`.
...
#> 
#> Running time of the GPS model fitting: 0.041 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
