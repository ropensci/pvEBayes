...
#> ✔ Fitting general-gamma model... [204ms]
#> 
...
#> 
#> Running time of the general-gamma model fitting: 0.2111 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (1000 signal strength posterior draws per AE-drug pair):0.0443 seconds.
#> 
