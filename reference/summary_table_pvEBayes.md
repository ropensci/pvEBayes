...
#> ✔ Fitting general-gamma model... [328ms]
#> 
...
#> 
#> Running time of the general-gamma model fitting: 0.3361 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (100 signal strength posterior draws per AE-drug pair):0.0219 seconds.
#> 
