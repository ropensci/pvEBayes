...
#> ✔ Fitting general-gamma model... [303ms]
#> 
...
#> 
#> Running time of the general-gamma model fitting: 0.3111 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (100 signal strength posterior draws per AE-drug pair):0.02 seconds.
#> 
