...
#> ✔ Fitting general-gamma model... [301ms]
#> 
#> ℹ Generating 10000 posterior draws...
#> ✔ Generating 10000 posterior draws... [308ms]
#> 
...
#> 
#> Running time of the general-gamma model fitting: 0.3083 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (10000 signal strength posterior draws per AE-drug pair):0.3151 seconds.
#> 
